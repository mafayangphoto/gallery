...
function PortalTab() {
    ...
    const [tabList] = useState([{name:'Home',hasChild:false,allowClick:true},{name:'beauty',hasChild:false,allowClick:true},{name:'portrait',hasChild:true,allowClick:true},{name:'product',hasChild:true,allowClick:true},{name:'event',hasChild:true,allowClick:false},])
