      ...
      <div className={`fixed w-full h-full sm:hidden bg-stone-100 transition-transform transform flex flex-col ${isBarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          ...
          <div className='grow '>
            <div className={`h-full flex justify-between flex-col transition-transform transform duration-300 delay-50 ${isBarOpen ? 'translate-x-0' : '-translate-x-full'} `} >
              ...
              <div className='mb-10 flex items-center justify-center '><div className='w-20 flex items-center justify-center'><Link target="_blank" rel="noopener noreferrer" href={'https://www.instagram.com/mafa_771/'}><IoLogoInstagram  className='text-neutral-700 active:text-zinc-400'  size={30}/></Link></div><div className='w-20 flex items-center justify-center'><Link href={'mailto:mafayangphoto@gmail.com'}><MdOutlineEmail  className='text-neutral-700 active:text-zinc-400'  size={30}/></Link></div></div>
            </div>
          </div>
      </div>
    </div>
