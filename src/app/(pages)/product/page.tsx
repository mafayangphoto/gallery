...
import { productImages } from './imagesLib';
  ...
  return (
    <div className='w-full flex px-2.5 flex-col sm:flex-row'>
        <div className='flex w-full sm:w-2/5'>
            <div >
                {productImages.blockOne.map((img,idx:number) => {
                    return(
        ...
        <div className='flex w-full sm:w-2/5'>
            <div >
                {productImages.blockTwo.map((img,idx:number) => {
                    return(
        ...
        <div className='flex w-full sm:w-2/5'>
            <div >
                {productImages.blockThree.map((img,idx:number) => {
                    return(
